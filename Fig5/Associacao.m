...
parfor S=1:length(Krice)
[gammaSrf,noiseRF,nUsers,nLeds,Ar,dv,Psi_k,phi,Psic,phi12,l,Ts,r,gamma,eta,echarge,I_DC,B,Xamb,i_amp,gVLC,gEveVLC,gEveVLCtil,noiseEveVLC,nAntenas,RFfonte,percurso,hbRF,heRF,heRFtil]=CSSNR(Kdb(S));
...
save IndAlgpot20VLC302.mat IndTotal
save CSTotalAlgpot20VLC302.mat CSTotal
save sumAlgpot20VLC302.mat sumexp
toc
