...
function [gammaSrf,noiseRF,nUsers,nLeds,Ar,dv,Psi_k,phi,Psic,phi12,l,Ts,r,gamma,eta,echarge,Pot_Led,B,Xamb,i_amp,gVLC,gEveVLC,gEveVLCtil,noiseEveVLC,nAntenas,RFfonte,percurso,hbRF,heRF,heRFtil]=CSSNR(Kdb)
%clc
%clear all
PsRf = 20;          
